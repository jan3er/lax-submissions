...
namespace Lax12Proofs.Densification

open Lax12Proofs.ShallowMinors Real Filter Finset MeasureTheory ProbabilityTheory PMF NNReal
...
Uses `Lax12Proofs.ChernoffBound.chernoffBound` applied twice (once for |A|, once per vertex
...
private lemma exists_good_pair (ε : ℝ) (hε_pos : 0 < ε) (hε_le : ε ≤ 2 / 3) :
  ...
  have h_chernoff_A :=
    Lax12Proofs.ChernoffBound.chernoffBound hp_icc hY_meas hY_indep hY_bern hY_mean hδ
  ...
  have h_good_pos : 0 < μ.real good_event := by
    ...
    have h_bad_B : μ.real {ω | ¬ ((n : ℝ) / 2 ≤
      ...
      have h_chernoff_vtx : ∀ v : V,
        ...
        have h_chernoff_Z :=
          Lax12Proofs.ChernoffBound.chernoffBound hp_icc
