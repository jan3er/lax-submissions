...
namespace Lax12Proofs.ScolByAdm

open Classical
open Lax12Proofs.TreeCounting
...
theorem scol_le_one_add_adm_sub_one_pow (G : SimpleGraph V) (r : ℕ) :
    Lax12Proofs.OrderedParameters.scol G r ≤
      1 + (Lax12Proofs.OrderedParameters.adm G r - 1) ^ r := by
  classical
