...
namespace Lax12Proofs.OrderedParameterBounds
...
private theorem admVertex_le_sreach_ncard (G : SimpleGraph V) (r : ℕ) (v : V) :
    Lax12Proofs.OrderedParameters.admVertex G r v ≤ (SReach G r v).ncard := by
  unfold Lax12Proofs.OrderedParameters.admVertex
  have hsup :
...
theorem scol_le_wcol (G : SimpleGraph V) (r : ℕ) :
  ...
  apply le_trans _ (Finset.le_sup (f := fun v =>
    (Lax12Proofs.OrderedParameters.WReach G r v).ncard) (by simp : v ∈ Finset.univ))
  apply Set.ncard_le_ncard
  · intro u hu
    simp only [Lax12Proofs.OrderedParameters.SReach, Lax12Proofs.OrderedParameters.WReach,
      Set.mem_setOf_eq] at *
...
end Lax12Proofs.OrderedParameterBounds
