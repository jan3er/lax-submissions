...
`Lax12Proofs.NowhereDenseNC` so the shallow-minor and weak-ordering
bookkeeping can be checked independently.
-/

namespace Lax12Proofs.NowhereDenseNeighborhoods

open scoped SimpleGraph
open Lax12.GraphClasses
open Lax12.NowhereDenseClasses
...
end Lax12Proofs.NowhereDenseNeighborhoods
