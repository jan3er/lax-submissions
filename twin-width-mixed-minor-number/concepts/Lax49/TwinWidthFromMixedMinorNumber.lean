...
namespace Lax49.TwinWidthFromMixedMinorNumber
...
axiom exists_twinWidth_bound_of_mixedMinorNumber :
    ∃ f : ℕ → ℕ, ∀ {V : Type} [Fintype V] [DecidableEq V]
      (G : SimpleGraph V),
      Lax48.TwinWidth.twinWidth G ≤ f (Lax49.MixedMinorNumber.mixedMinorNumber G)

end Lax49.TwinWidthFromMixedMinorNumber
