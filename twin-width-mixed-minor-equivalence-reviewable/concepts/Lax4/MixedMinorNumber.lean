...
namespace Lax4.MixedMinorNumber

/-- A division of `Fin n` into `k` nonempty, disjoint, covering, convex parts
in increasing order. -/
...
/-- The indexed parts of a division. -/
...
This packages the minimization convention used for graph mixed minor number. -/
