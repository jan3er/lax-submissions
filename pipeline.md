...
| 9 | Cor 6a (weakly sparse + mon dep ⇒ nowhere dense) | Mählmann thesis Lem 13.7/13.8 + §2 star-crossing hardness (was: left open) | **very high** — PROVED (see `cor6a-plan.md`) | Discharged 2026-07-25 by recycling the autoformalize/4 catalog (Ramsey toolbox, ND bridge, 13.8) plus a new star-crossing transduction and 13.7 glue; headline theorem now standard-axioms-only. |
