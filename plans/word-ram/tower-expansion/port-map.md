...
| matrices: `Matrix` intf + array matrix | AFP `IICF_Array_Matrix` (23.5 KB) + Sepreftime (10.4 KB, cost) | P5.A | Floyd–Warshall-class; PCP constraint graphs | **P5.C — `Array_Matrix` green as an unrooted leaf (1/5 P5.C families); `Abs_Heap` next** |
