...
theorem ContractionSequence.hasManyPChildren_of_hasManyChildrenInPart_of_nonpreleaf
  ...
  Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.hasManyPChildren_of_hasManyChildrenInPart_of_nonpreleaf
...
theorem ContractionSequence.qProperty_of_hasManyChildrenInPart
  ...
  Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.qProperty_of_hasManyChildrenInPart
    (k := k) (d := d) (P := (S.state i).bags) (u := u) (hlevel := hlevel)
    hd (Lax1Proofs.TwinWidth.SimpleGraph.TrigraphState.isBagPartition (S.state i))
    hroot (Lax1Proofs.TwinWidth.SimpleGraph.ContractionSequence.partitionRedDegreeAtMost_state S hi)
    hP
...
theorem ContractionSequence.hasManyChildrenInPart_step
  ...
  hasManyChildrenInPart_mono_of_isBagContraction
    (Lax1Proofs.TwinWidth.SimpleGraph.IsContractionStep.isBagContraction
...
theorem ContractionSequence.hasManyChildrenInPart_mono
  ...
  | @step n hij ih =>
      ...
      exact
        Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.ContractionSequence.hasManyChildrenInPart_step
...
theorem ContractionSequence.qProperty_mono
  ...
  | @step n hij ih =>
      ...
      exact
        Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.ContractionSequence.qProperty_step
          S (Nat.lt_of_succ_le hj) hprev
...
theorem ContractionSequence.exists_hasManyChildrenInPart_before_of_not_tree_singleton
  ...
  have hpartP : IsBagPartition (S.state p).bags :=
    Lax1Proofs.TwinWidth.SimpleGraph.TrigraphState.isBagPartition (S.state p)
  have hpartQ : IsBagPartition (S.state (p + 1)).bags :=
    Lax1Proofs.TwinWidth.SimpleGraph.TrigraphState.isBagPartition (S.state (p + 1))
  have hredQ :
      PartitionRedDegreeAtMost (bonnetDepresGraph k) (S.state (p + 1)).bags d :=
    Lax1Proofs.TwinWidth.SimpleGraph.ContractionSequence.partitionRedDegreeAtMost_state
      S (by
        have hfirst_le :=
          ContractionSequence.firstRootChildrenNonSingletonIndex_le_stepCount S
        omega)
...
theorem ContractionSequence.exists_rootChild_hasManyChildrenInPart_before_first
  ...
  have hpartPrev : IsBagPartition (S.state i).bags :=
    Lax1Proofs.TwinWidth.SimpleGraph.TrigraphState.isBagPartition (S.state i)
  have hpartFirst :
      IsBagPartition (S.state (ContractionSequence.firstRootChildrenNonSingletonIndex S)).bags :=
    Lax1Proofs.TwinWidth.SimpleGraph.TrigraphState.isBagPartition
...
theorem ContractionSequence.treeVertex_singleton_of_not_qProperty_before_firstRootChildQIndex
  ...
  have hPpred :
    ...
    Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.ContractionSequence.hasManyChildrenInPart_mono
  ...
  have hQpred :
      QProperty (S.state (i - 1)).bags u :=
    Lax1Proofs.TwinWidth.SimpleGraph.BonnetDepres.ContractionSequence.qProperty_of_hasManyChildrenInPart
...
theorem bonnetDepres_two_pow_lt_twinWidth (k : ℕ) :
  ...
  Lax1Proofs.TwinWidth.SimpleGraph.lt_twinWidth_of_not_hasTwinWidthAtMost
